...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-14 07:16`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f4a06cb0-8cf6-4aae-b702-b52620a3421d.git
$ cd f4a06cb0-8cf6-4aae-b702-b52620a3421d
```
